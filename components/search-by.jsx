...
export default function SearchBy({
  ...
  useEffect(() => {
    if (!isDisabled) {
      searchBy === 'Any'
        ? removeQueryParam('searchBy', router)
        : addQueryParam('searchBy', searchBy, router);
    }
  }, [searchBy]);
          ...
          {({ open }) => (
            <>
              ...
              <div className='relative mt-1'>
                <Listbox.Button className='relative w-full md:w-48 text-sm cursor-default rounded-md border border-gray-300 bg-white py-2 pl-1 pr-1 text-left shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-blue-500'>
                      ...
                      <Listbox.Option
                        ...
                        className={({ active }) =>
                          classNames(
                            ...
                            'relative cursor-default select-none py-2 pl-3 pr-3 text-sm',
                          )
                        }
                        value={key}
                      >
