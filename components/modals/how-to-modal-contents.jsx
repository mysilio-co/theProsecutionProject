...
export default function HowToModalContents ({setShowModal}) {
    ...
    return (
        <Dialog.Panel ref={contentRef} className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full md:m-auto md:w-5/6">
