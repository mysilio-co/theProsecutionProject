          ...
          <div className='mt-0 text-center sm:text-left w-full'>
            <div className='mt-2 p-4 pb-0 text-center'>
              ...
              <p className='mt-6 text-sm text-gray-500'>
                This tab includes cases currently being investigated and coded
                by researchers as well as those still proceeding through the
                courts. These cases have not been completed, will change over
                time, and have not been audited. These cases are provided as a
                resource, but should be independently investigated and verified
                before being included in research products.
              </p>
            </div>
          </div>
        </div>
