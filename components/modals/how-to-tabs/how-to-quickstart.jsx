...
export default function HowToQuickstart({router}) {
    ...
    return (
        <div>
            ...
            <ContentDisclosure
                name={"Females between 18-50 with any manner of rightest ideology who target people"} 
                content={
                    <div className="text-start">
                        <h4 className="text-gray-700 mb-2">Categorical Filters</h4>
            ...
            <ContentDisclosure
                ...
                content={
                    <div className="text-start">
                        <h4 className="text-gray-700 mb-2">Categorical Filters</h4>
                        <p className="mt-0">Criminal Method - Firearms: civilian, Firearms: military</p>
                        <p className="mt-0">Veteran Status - Active duty, Dishonorably discharged, Former Active duty, Former active duty and current reserve components, Former active duty and reserve components, Former reserve components, Former/current member of non-U.S. military, Hardship discharge, Honorably discharged, Other than honorable discharge, Reserve/national guard (reserve components)</p>
                        <button onClick={()=>{
                            goToExample(
                                {
                                    "tab": "General",
                                    "Veteran status": "Active duty, Dishonorably discharged, Former Active duty, Former active duty and current reserve components, Former active duty and reserve components, Former reserve components, Former/current member of non-U.S. military, Hardship discharge, Honorably discharged, Other than honorable discharge, Reserve/national guard (reserve components)",
            ...
            <ContentDisclosure
                ...
                content={
                    <div className="text-start">
                        ...
                        <h4 className="text-gray-700 mb-2">Categorical Filters</h4>
                        <p className="mt-0">Verdict - Guilty, Guilty on some charges/not guilty on others</p>
                        <button onClick={()=>{
                            goToExample(
                                {
                                    "tab": "General",
